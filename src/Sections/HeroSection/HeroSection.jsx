...
export default function HeroSection() {
  ...
  return (
    <section
      className={`px-5 sm:px-10 md:20 lg:px-35 mt-16 lg:mt-18 w-full py-12 lg:py-25 flex flex-col-reverse lg:flex-row items-center justify-center transition-colors duration-300 
      ...
      <div className="flex flex-col-reverse lg:flex-row items-center justify-between w-full gap-8">
        ...
        <div data-aos="flip-right" className="flex justify-center">
          <img
            src={MyPhoto}
            alt="Raza Shaikh"
            className="w-48 h-48 sm:w-64 sm:h-64 lg:w-90 lg:h-90 object-cover rounded-full drop-shadow-2xl"
          />
        </div>
      </div>
    </section>
